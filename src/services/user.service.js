...
const findUsernameService = (username) => User.find(username)
...
export default { createUserService, findAllUsersService, findUserIdService, findUsernameService, findUserEmailService, updtUserService }